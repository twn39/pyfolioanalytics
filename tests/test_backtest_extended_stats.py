...
def test_extended_summary_stats():
    ...
    returns = pd.Series([0.01, -0.02, 0.03, -0.01, 0.05, -0.03, 0.02, 0.01, -0.01, 0.04], index=dates)
    benchmark = pd.Series([0.005, -0.01, 0.02, -0.005, 0.03, -0.02, 0.01, 0.005, -0.005, 0.02], index=dates)
