...
def test_socp_return_uncertainty():
    ...
    res_robust = optimize_portfolio(R, port, delta_mu=0.001, robust_mu_type="ellipsoidal", sigma_mu=sigma_mu, k_mu=2.0)
...
def test_socp_covariance_uncertainty():
    ...
    res_robust = optimize_portfolio(R, port, robust_sigma_type="ellipsoidal", sigma_sigma=sigma_sigma, k_sigma=1.0)
