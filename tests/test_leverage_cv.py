...
def test_leverage_exposure_logic():
    ...
    res_un = optimize_portfolio(
        R=R, portfolio=pspec_unconstrained, optimize_method="cvxpy"
    )
    ...
    res_con = optimize_portfolio(
        R=R, portfolio=pspec_constrained, optimize_method="cvxpy"
    )
