...
def test_backtest_stats_cv(stocks_data):
    ...
    np.testing.assert_allclose(summary.loc["Up Capture Ratio", "Gross"], expected_up_cap)
    ...
    np.testing.assert_allclose(summary.loc["Down Capture Ratio", "Gross"], expected_down_cap)
